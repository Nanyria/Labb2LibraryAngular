...
namespace FinalProjectLibrary.Migrations
{
    ...
    [Migration("20250514155809_bookType")]
            ...
            modelBuilder.Entity("FinalProjectLibrary.Models.History.StatusHistoryItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Timestamp = new DateTime(2025, 5, 13, 15, 58, 8, 551, DateTimeKind.Utc).AddTicks(2746)
                        },
                        new
                        {
                            ...
                            BookStatus = 2,
                            Notes = "Initial status",
                            Timestamp = new DateTime(2025, 5, 12, 15, 58, 8, 551, DateTimeKind.Utc).AddTicks(2751)
                        },
                        new
                        {
                            ...
                            BookStatus = 1,
                            Notes = "Initial status",
                            Timestamp = new DateTime(2025, 5, 11, 15, 58, 8, 551, DateTimeKind.Utc).AddTicks(2752)
                        });
                });
