...
namespace FinalProjectLibrary.Migrations
{
    ...
    [Migration("20250514162658_admin")]
    partial class admin
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinalProjectLibrary.Models.History.StatusHistoryItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Timestamp = new DateTime(2025, 5, 13, 16, 26, 57, 704, DateTimeKind.Utc).AddTicks(2829)
                        },
                        new
                        {
                            ...
                            BookStatus = 2,
                            Notes = "Initial status",
                            Timestamp = new DateTime(2025, 5, 12, 16, 26, 57, 704, DateTimeKind.Utc).AddTicks(2834)
                        },
                        new
                        {
                            ...
                            BookStatus = 1,
                            Notes = "Initial status",
                            Timestamp = new DateTime(2025, 5, 11, 16, 26, 57, 704, DateTimeKind.Utc).AddTicks(2836)
                        });
                });
